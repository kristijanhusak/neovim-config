...
" Move between slits
nnoremap <c-h> <C-w>h
nnoremap <silent><expr><c-j> skylight#float#has_scroll() ? skylight#float#scroll(1, 1) : "\<C-w>j"
nnoremap <silent><expr><c-k> skylight#float#has_scroll() ? skylight#float#scroll(0, 1) : "\<C-w>k"
nnoremap <c-l> <C-w>l
