function! s:packager_init(packager) abort
  ...
  call a:packager.add('kristijanhusak/vim-create-pr')
  call a:packager.add('kristijanhusak/vim-dadbod')
  call a:packager.add('kristijanhusak/vim-dadbod-completion', {'requires': 'kristijanhusak/vim-dadbod'})
  call a:packager.add('kristijanhusak/vim-dadbod-ui', {'requires': 'kristijanhusak/vim-dadbod'})
  call a:packager.add('lambdalisue/vim-backslash')
  call a:packager.add('lambdalisue/reword.vim')
  call a:packager.add('AndrewRadev/tagalong.vim')
  ...
  call a:packager.add('junegunn/fzf', { 'do': './install --all && ln -sf $(pwd) ~/.fzf'})
  call a:packager.add('junegunn/fzf.vim')
  call a:packager.add('ludovicchabant/vim-gutentags')
  ...
  call a:packager.add('osyo-manga/vim-anzu')
  call a:packager.add('stefandtw/quickfix-reflector.vim')
  call a:packager.add('dense-analysis/ale')
  call a:packager.add('wakatime/vim-wakatime')
  ...
  call a:packager.add('nvim-treesitter/nvim-treesitter-refactor')
  call a:packager.add('nvim-treesitter/nvim-treesitter-textobjects')
  call a:packager.add('hrsh7th/vim-vsnip')
  call a:packager.add('hrsh7th/vim-vsnip-integ')
  call a:packager.add('kyazdani42/nvim-tree.lua', {'requires': 'kyazdani42/nvim-web-devicons'})
  call a:packager.add('kristijanhusak/any-jump.vim')
  call a:packager.add('tommcdo/vim-exchange')
  call a:packager.add('unblevable/quick-scope')
  call a:packager.add('hrsh7th/nvim-compe')
  call a:packager.add('sainnhe/edge')
  call a:packager.add('voldikss/vim-skylight')
endfunction
