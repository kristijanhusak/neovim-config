...
hl.bind(mod .. ' + EQUAL', hl.dsp.layout('resize right'))
hl.bind(mod .. ' + minus', hl.dsp.layout('resize left'))
...
hl.define_submap('resize', function()
  ...
  hl.bind('k', hl.dsp.layout('resize up'))
  hl.bind('l', hl.dsp.layout('resize right'))
